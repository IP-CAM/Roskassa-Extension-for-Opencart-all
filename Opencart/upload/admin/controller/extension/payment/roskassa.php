...
class ControllerExtensionPaymentRoskassa extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['payment_roskassa_account'])) {
			$data['payment_roskassa_account'] = $this->request->post['payment_roskassa_account'];
		} else {
			$data['payment_roskassa_account'] = $this->config->get('payment_roskassa_account');
		}

		if (isset($this->request->post['payment_roskassa_secret'])) {
			$data['payment_roskassa_secret'] = $this->request->post['payment_roskassa_secret'];
		} else {
			$data['payment_roskassa_secret'] = $this->config->get('payment_roskassa_secret');
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['payment_roskassa_account']) {
			$this->error['account'] = $this->language->get('error_account');
		}

		if (!$this->request->post['payment_roskassa_secret']) {
